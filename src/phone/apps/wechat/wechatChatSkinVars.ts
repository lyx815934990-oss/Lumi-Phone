...
export const WECHAT_CHAT_SKIN_DEFAULTS = {
  ...
  specialCallBg: '#ffffff',
  specialCallText: '#191919',
  specialCallMuted: '#8e8e8e',
  specialCallBorder: 'rgba(0,0,0,0.08)',
  specialFavBg: '#ffffff',
  specialFavBorder: 'rgba(0,0,0,0.08)',
  specialFavTitle: '#191919',
  specialFavMuted: '#8e8e8e',
  specialListenBg: 'rgba(255,255,255,0.75)',
  specialListenBorder: 'rgba(0,0,0,0.08)',
  specialListenTitle: '#2D2422',
  specialListenMuted: '#78716c',
  specialListenAccent: '#57534e',
} as const
...
const SKIN_VAR_MAP: Record<keyof typeof WECHAT_CHAT_SKIN_DEFAULTS, string> = {
  ...
  specialCallBg: '--wx-special-call-bg',
  specialCallText: '--wx-special-call-text',
  specialCallMuted: '--wx-special-call-muted',
  specialCallBorder: '--wx-special-call-border',
  specialFavBg: '--wx-special-fav-bg',
  specialFavBorder: '--wx-special-fav-border',
  specialFavTitle: '--wx-special-fav-title',
  specialFavMuted: '--wx-special-fav-muted',
  specialListenBg: '--wx-special-listen-bg',
  specialListenBorder: '--wx-special-listen-border',
  specialListenTitle: '--wx-special-listen-title',
  specialListenMuted: '--wx-special-listen-muted',
  specialListenAccent: '--wx-special-listen-accent',
}
...
export const WECHAT_CHAT_SKIN_SELECTOR_DOC = [
  ...
  '--wx-chat-header-bg / --wx-chat-header-bg-image — 顶栏底色 / 背景图（url(...) 或 none）',
  '--wx-chat-header-bg-image-blur / --wx-chat-header-bg-overlay / --wx-chat-header-bg-overlay-opacity — 背景图模糊与颜色遮罩',
  '[data-wx-chat-header-btn="back"|"time"|"psyche"|"more"] — 顶栏按钮',
  '[data-wx-chat-header-avatar] — 标题区角色头像（默认隐藏，皮肤可显示）',
  '[data-wx-chat-header-title] — 联系人昵称',
  '[data-wx-chat-header-title-wrap] — 标题区容器（头像+昵称）',
  '[data-wx-chat-header-sub] — 顶栏副标题/输入中',
  '[data-wx-chat-input-bar] — 底部输入栏外框',
  '--wx-chat-input-bar-bg / --wx-chat-input-bar-bg-image — 输入栏底色 / 背景图',
  '--wx-chat-input-bar-bg-image-blur / --wx-chat-input-bar-bg-overlay / --wx-chat-input-bar-bg-overlay-opacity — 背景图模糊与颜色遮罩',
  ...
  '[data-wx-msg-kind="text"|"voice"|"red-packet"|"transfer"|"location"|"voice-call"|"favorite"|"listen-together"] — 消息类型',
  '[data-wx-special-card] — 特殊消息卡片根（红包/转账/位置/通话/收藏/听一听等）',
  '[data-wx-special-status] — 状态（pending|accepted|unclaimed|claimed|invite|accepted|…）',
  '[data-wx-special-part="icon"|"amount"|"label"|"status"|"footer"|"map"|"play"|"wave"|"cover"|"action"] — 卡内零件',
  '[data-wx-bubble-cluster="single"|"first"|"middle"|"last"] — 连续气泡位置（分化圆角）',
  '[data-wx-chat-input-btn="voice"|"emoji"|"plus"|"send"] — 输入栏按钮',
  '[data-wx-chat-input-icon="mic"|"keyboard"|"emoji"] — 输入栏按钮当前图标态（用于换肤）',
  '[data-wx-timestamp] — 时间戳/日期分割线',
] as const
