...
7. educationTrack / educationGradeAtStart 是**开篇**学年；现在读到哪写在 educationNote 与 occupationMain。**近端剧情 / 剧情日推算的当前年级优先于世界书开篇年级**（例：相遇羁绊开篇大三，近端已称大四学长 → 账本现在必须大四，不可因世界书仍写大三而 noChange）。开局建档时禁止把世界书大三改成大二，或把已是大一写成「待升大一」。学校/专业口径须与权威身份设定一致，且校名为具体虚构专名。
8. storyStartDay / 主体 ageAtStart 默认勿动。近端明确「现在几岁」可另输出 currentAge。
9. 证据矛盾：${
      params.subject === 'player'
        ? '学校/专业/主业身份 → 玩家身份设定优先；年级「现在」口径 → 近端明示与剧情日优先于世界书开篇；其余动态事实取更近更具体的近端。'
        : '年级「现在」口径 → 近端明示与剧情日优先于世界书开篇；其余取更近更具体；职业感情等有依据才改。'
    }空白补齐允许轻度合理推断。共同社交对象客观事实以「对方账本社交圈锚点」为准，不得另编一套学校。
10. 仅当账本**已无空白且**与证据完全一致、且**地址/校名无「某」等模糊占位**、且**共同好友客观事实与对方账本一致**、且**occupation/学历年级已是「现在」而非停在开篇**时才输出 {"noChange":true}。仍有空住所/空车产/空家庭/空社交圈、或家庭/社交圈年龄仍停在开篇、或职业仍是空话、或住所/家庭地址仍笼统/含「某」、或宿舍缺楼栋房间号、或共同好友学校与对方不一致、或**玩家账本学校/专业仍与身份卡冲突**、或**近端已写大四/大二而账本仍大三/大一**时**禁止** noChange。
