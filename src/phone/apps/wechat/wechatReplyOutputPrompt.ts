...
- **拿下次约定说事**：有无「看你明天见到我还敢不敢」「你看我后天不××」「等见面再收拾你/算账/治你」等拿约定当威胁预告？有则**整句删改**，正常约时间即可，勿吊「等见面……」。
...
- **硬损反撩套话**：有无「这就害羞了？」「刚刚不是很有能耐吗？」「等我回去收拾你」「等着」「这就怂了？」「胆子越来越肥了」「胆子肥了」「越来越放肆」「皮痒了」「欠收拾」「翅膀硬了」「给你脸了」等同义变体？有则**整句删改**成就事接话/短损收住；勿把每轮推拉写成同一套偶像剧模板。
