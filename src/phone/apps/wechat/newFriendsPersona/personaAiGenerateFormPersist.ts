...
export function normalizePersonaAiGenerateForm(raw: unknown): PersonaAiGenerateForm | null {
  ...
  return {
    ...
    occupationMutable: !!o.occupationMutable,
    ...
    meetingProcessPresetId: pickStr('meetingProcessPresetId'),
    historyCharIdentity: pickStr('historyCharIdentity'),
    historyUserIdentity: pickStr('historyUserIdentity'),
    presentCharIdentity: pickStr('presentCharIdentity'),
    presentUserIdentity: pickStr('presentUserIdentity'),
    identityArcPresetId: pickStr('identityArcPresetId'),
